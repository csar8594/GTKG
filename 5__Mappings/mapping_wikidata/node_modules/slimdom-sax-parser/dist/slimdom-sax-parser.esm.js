import * as slimdom$1 from 'slimdom';
import slimdom__default from 'slimdom';
...
function createHandler(parser, options) {
  ...
  // namespaces.
  var document = new slimdom__default.Document(); // The node into which new child nodes are inserted. Is rewritten as the handler traverses in and out of elements.
